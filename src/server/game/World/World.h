...
enum WorldIntConfigs
{
    ...
    CONFIG_ANTIHACKER_ACTION,
    CONFIG_ANTIHACKER_MAX_REPORTS,
    CONFIG_ANTIHACKER_REFRESH_TIME,
    CONFIG_ANTIHACKER_AVERAGE_SPEED,
    CONFIG_ANTIHACKER_IGNORE_LATENCY,
    CONFIG_ANTIHACKER_IGNORE_ACCOUNT_RANK,
