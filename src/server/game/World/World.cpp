...
#include "../../../src/server/scripts/Custom/npc_template.h"
#include "World.h"
...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_ANTIHACKER_ENABLE] = sConfigMgr->GetBoolDefault("Antihacker.Enable", false);
    m_int_configs[CONFIG_ANTIHACKER_ACTION] = sConfigMgr->GetIntDefault("Antihacker.Action", 0);
    m_int_configs[CONFIG_ANTIHACKER_MAX_REPORTS] = sConfigMgr->GetIntDefault("Antihacker.MaxReports", 10);
    m_int_configs[CONFIG_ANTIHACKER_REFRESH_TIME] = sConfigMgr->GetIntDefault("Antihacker.RefreshTime", 5000);
    m_int_configs[CONFIG_ANTIHACKER_AVERAGE_SPEED] = sConfigMgr->GetIntDefault("Antihacker.AverageSpeed", 1000);
    m_int_configs[CONFIG_ANTIHACKER_IGNORE_LATENCY] = sConfigMgr->GetIntDefault("Antihacker.IgnoreLatency", 1000);
    m_int_configs[CONFIG_ANTIHACKER_IGNORE_ACCOUNT_RANK] = sConfigMgr->GetIntDefault("Antihacker.IgnoreAccountRank", 0);
