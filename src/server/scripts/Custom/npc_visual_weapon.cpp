...
public:
    ...
    static void SetVisual(Player* player, uint32 visual)
    {
    ...
    static void GetMenu(Player* player, Creature* creature, uint32 menuId)
    {
    ...
    {
        AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-MainHand:32:32:-32:0|tMain-Hand", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-SecondaryHand:32:32:-32:0|tOff-Hand", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
        AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:32:32:-32:0|tSair", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
...
bool NPC_VisualWeapon::MainHand = true;
